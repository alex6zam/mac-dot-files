  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        ["<Leader>gCB"] = { "<cmd>GitConflictChooseBase<CR>" },
        ["<Leader>gCb"] = { "<cmd>GitConflictChooseBoth<CR>" },
        ["<Leader>gCn"] = { "<cmd>GitConflictChooseNone<CR>" },
        ...
        ["<Leader>gBc"] = { "<cmd>GitBlameCopyFileURL<cr>", desc = "Copy current line remote url to clipboard" },
